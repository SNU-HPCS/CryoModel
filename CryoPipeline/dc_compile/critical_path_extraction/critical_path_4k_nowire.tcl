...
redirect ${REPORT_DIR}/${TOP_MODULE}_critical_path_4k_nowire {report_timing -through [get_pins -of_objects {  genblk1.vcr/ips[6].ipc/chi/genblk2.genblk1.flit_ctrlq*}] -through [get_pins -of_objects {  genblk1.vcr/ips[9].ipc/fb/genblk2.samqc/queues[1].genblk1.genblk1.pop_next_addrq*}]}
