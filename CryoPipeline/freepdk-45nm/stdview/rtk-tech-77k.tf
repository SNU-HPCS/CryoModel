...
Layer		"metal1" {
		...
		unitMinResistance		= 0.000194
		unitNomResistance		= 0.000194
		unitMaxResistance		= 0.000194
...
Layer		"metal2" {
		...
		unitMinResistance		= 0.000123
		unitNomResistance		= 0.000123
		unitMaxResistance		= 0.000123
...
Layer		"metal7" {
		...
		unitMinResistance		= 1.8e-05
		unitNomResistance		= 1.8e-05
		unitMaxResistance		= 1.8e-05
...
Layer		"metal9" {
		...
		unitMinResistance		= 6e-06
		unitNomResistance		= 6e-06
		unitMaxResistance		= 6e-06
...
Layer		"via9" {
		...
		unitNomResistance		= 0.0001
		unitMaxResistance		= 0.0001
}
